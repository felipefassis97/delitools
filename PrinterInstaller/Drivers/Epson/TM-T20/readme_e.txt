                      ...
                      TMUSB device driver version 8.00e
...
--------------
2.1 Support OS
  + Microsoft(R) Windows 10(R) 32bit
  + Microsoft(R) Windows 10(R) 64bit
  + Microsoft(R) Windows 11(R) 64bit
  + Microsoft(R) Windows 11(R) ARM64
  + Microsoft(R) Windows Server(R) 2016 64bit
  + Microsoft(R) Windows Server(R) 2019 64bit
  + Microsoft(R) Windows Server(R) 2022 64bit
  + Microsoft(R) Windows Server(R) 2025 64bit
...
----------
  ...
  + TMUSB800c
     + SETUP.exe
     + TMUSBXP  .....Folder containing TMUSB Driver files for 32Bit
     + TMUSB64  .....Folder containing TMUSB Driver files for 64Bit
     + TMUSBA64 .....Folder containing TMUSB Driver files for ARM64
     + ReadMeJ.txt
     + ReadMeE.txt
...
6. HISTORY
----------  
  + 11/25/2025 Version 8.00e Added support for Windows 11 ARM64 and Windows Server 2025.
